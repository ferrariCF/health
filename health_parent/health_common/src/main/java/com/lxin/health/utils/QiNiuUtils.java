...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "Uz92-AWyblibO8nVAm62ikSt8mQXp2NOT311mM05";
    private static final String SECRETKEY = "E6wvZhkC-xQbHDFQuDFoh13_ZfXXE4LtUoTR1zye";
    private static final String BUCKET = "fluuuuu";
    public static final String DOMAIN= "http://qvt0pp4as.hn-bkt.clouddn.com/";

    public static void main(String[] args) {
        //uploadFile("D:\\QQ\\iu.jpg","dd2.jpg");
